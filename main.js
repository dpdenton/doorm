...
var postgres_1 = require("./lorm/utils/postgres");
var QueryBuilder_1 = require("./lorm/QueryBuilder");
(function main() {
    return __awaiter(this, void 0, void 0, function () {
        var rateableTable, rateableQB, placeTable, placeQB, sql;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, postgres_1.createTable({
                        pk: 'id',
                        tableName: 'Rateables',
                        include: ['CategoryId']
                    })];
                case 1:
                    rateableTable = _a.sent();
                    rateableQB = new QueryBuilder_1["default"]();
                    rateableQB
                        .select(rateableTable.columns).from(rateableTable.name);
                    save('base');
                    return [4 /*yield*/, postgres_1.createTable({
                            pk: 'id',
                            tableName: 'Places',
                ...
                case 2:
                    placeTable = _a.sent();
                    placeQB = new QueryBuilder_1["default"]();
                    placeQB
                        .select(placeTable.columns)
                        .sql("FROM \"Places\"")
                        .save('base');
                    sql = placeQB.get('base')
